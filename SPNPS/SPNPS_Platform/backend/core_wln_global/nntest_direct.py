...
def test_stage1():
    predfile = open('./core_wln_global/model-fine-tune-3130/pred.cbond_detailed', 'w')
    NK3 = 80
    NK2 = 40
    NK1 = 20
    NK0 = 16
    ...
    parser = OptionParser()
    parser.add_option("-t", "--test", dest="train_path", default="./data/pred.txt.proc")
    parser.add_option("-m", "--model", dest="model_path", default="./core_wln_global/model-fine-tune-3130")
    ...
    parser.add_option("-c", "--checkpoint", dest="checkpoint", default="ckpt-3130")
    ...
    parser.add_option("--detailed", dest="detailed", default=1) # whether to include scores in output
        ...
        while not coord.should_stop():
            ...
            for i in range(batch_size):
                ...
                if opts.verbose:
                    ...
                    predfile.write("{}".format(react_batch[i]) + ' ')
                    for j in range(NK3):
                        ...
                        if x < y and x in ratoms and y in ratoms and (x, y, bo) not in rbonds:
                            ...
                            if detailed: # include actual score of prediction
                                ...
                                predfile.write("{:.3f}".format(cur_sco[i, j]) + ' ')
                    # print('') # new line
                    predfile.write('\n')
