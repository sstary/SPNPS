...
from rank_diff_wln.mol_graph_direct_useScores import atom_fdim as adim, bond_fdim as bdim, max_nb, smiles2graph, bond_types
...
def test_stage2():
    predfile = open('./rank_diff_wln/model-fine-tune-ori/pred.cbond_detailed_13800', 'w')
    parser = OptionParser()
    parser.add_option("-t", "--test", dest="test_path", default="./data/pred.txt.proc")
    parser.add_option("-p", "--cand", dest="cand_path", default="./core_wln_global/model-fine-tune-3130/pred.cbond_detailed")
    parser.add_option("-a", "--ncand", dest="cand_size", default=1500)
    parser.add_option("-c", "--ncore", dest="core_size", default=16)
    parser.add_option("-m", "--model", dest="model_path", default="./rank_diff_wln/model-fine-tune-ori")
    parser.add_option("-w", "--hidden", dest="hidden_size", default=500)
    parser.add_option("-d", "--depth", dest="depth", default=3)
    parser.add_option("--checkpoint", dest="checkpoint", default="ckpt-13800")
    ...
    tk = tf.minimum(32, tf.shape(score)[0])
