...
import numpy as np
import random
from rank_diff_wln.edit_mol_direct_useScores import get_product_smiles
...
def smiles2graph(rsmiles, psmiles, core_bonds, gold_bonds, cutoff=500,
                 idxfunc=lambda x:x.GetIntProp('molAtomMapNumber') - 1, core_size=20, kmax=8, return_found=False,
                 testing=False):
...
if __name__ == "__main__":
    ...
    try:
        ...
        while True:
            ...
            _, core_configs, found_true = smiles2graph(rsmiles, psmiles, core_bonds, gold_bonds, cutoff=10000, core_size=20, kmax=8, return_found=True)
